...
public class PuertoTest
{
    ...
    public void testPuerto01()
    {
        ...
        assertEquals(1, puerto1.addAlquiler(5, cliente1, velero1,1));
        assertEquals(-1, puerto1.addAlquiler(2, cliente2, yate1,1));
        assertEquals(2, puerto1.addAlquiler(3, cliente3, embarcac1,2));
        Velero velero2 = new Velero(1, "BBB", 15, 2010);
        Cliente cliente4 = new Cliente("Julio Iglesias", "23444555K");
        assertEquals(3, puerto1.addAlquiler(10, cliente4, velero2,3));
        Cliente cliente5 = new Cliente("Pedro Duque", "89777444K");
        Yate yate2 = new Yate(8, 40000, "YYY", 45, 2012);
        assertEquals(-1, puerto1.addAlquiler(1, cliente5, yate2,3));
        puerto1.verEstadoAmarres();
        assertEquals(2200, puerto1.liquidarAlquiler(1), 0.1);
        assertEquals(-1, puerto1.addAlquiler(1, cliente5, yate2,2));
        puerto1.verEstadoAmarres();
    }
}
